...
@media (min-width:768px) {
  ...
  body {
  		background: url(resources/images/img/back.jpg)no-repeat center fixed;
...
<li class=""><a class="navbar-brand" href="login"><span class="glyphicon glyphicon-log-in">Login</span></a>

</li>
</li>
<li class="dropdown">
<li class=""><a class="navbar-brand" href="#"><span class="glyphicon glyphicon-th">Products</span></a><b class="caret"></b>
<ul class="dropdown-menu">
<li class ="dropdown-header">Clothing<li>

<li><a href="#">Mens wear</a></li>
<li><a href="women.html">womens wear</a></li>
<li class ="dropdown-header">Gadgets<li>

<li><a href="men.html">Mobiles</a></li>
...
<form class="navbar-form navbar-right" role="search">
 ...
 <center> <table>
  <tr>
  <td><img src="resources/images/img/2211.png" style="width: 300px;height: 300px"></td>
  </tr>
  <tr>
 <td>First Name:  </td>
  ...
  <div class="row">
        <div class="col-md-6 col-md-offset-3">
            <form:form action="SignUp" method="POST" accept-charset="utf-8" class="form" role="form" commandName="usersDetail">   
                    <img src="resources/images/img/register-here-button.jpg" style="width:600px;height:300px">
                  <h1 style="color:red">  ${message}</h1>
                    ...
                    <form:input type="email" path="email"  class="form-control input-lg" placeholder="Your Email" /><form:input type="password" path="password" value="" class="form-control input-lg" placeholder="Password" />
                                        ...
                                        <label>Birth of Date</label>                    <div class="row">
