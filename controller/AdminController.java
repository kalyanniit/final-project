...
import com.kalyanscart.service.ItemDaoService;
import com.kalyanscart.service.UsersDetailService;
@Controller
...
public String logout(HttpServletRequest request)
{
	...
	public String storeProduct(HttpServletRequest request,ModelMap model,@RequestParam("file") MultipartFile file, @Valid @ModelAttribute("shoes") Item p,BindingResult result)
	{
    	...
    	productService.addProduct(p);
         ...
         path = Paths.get("C:\\Users\\welcome\\Desktop\\shoeclue\\src\\main\\webapp\\resources\\images\\"+p.getProduct_id()+".jpg");
System.out.println();
